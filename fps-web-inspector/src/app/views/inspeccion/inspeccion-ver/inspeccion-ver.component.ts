...
import { COLLECTION_INSPECTION, COLLECTION_PHOTOS, COLLECTION_VIDEOS, COMPLETE, DB_COMPLETE, MSJ_FOTO_RECHAZADA, SIZE_ELEMENTS } from 'src/app/utils/constantes';
import { InspeccionFiltro } from 'src/app/models/inspeccion-filtro';
import Swal from 'sweetalert2';
import { ModalFotosComponent } from '../inspeccion-editar/modal-fotos/modal-fotos.component';

@Component({
  selector: 'app-inspeccion-ver',
  templateUrl: './inspeccion-ver.component.html',
  styleUrls: ['./inspeccion-ver.component.css']
})
export class InspeccionVerComponent implements OnInit {
  ...
  finalizarInspeccion() {
    Swal.fire({
      ...
      text: "Confirme guardar los cambios",
      icon: 'warning',
